"use strict";
var observable_1_1 = require("./observable.1");
var symbol_1 = require("../Utils/symbol");
(function (ObservableValueType) {
    ObservableValueType[ObservableValueType["Unknown"] = 0] = "Unknown";
    ObservableValueType[ObservableValueType["Value"] = 1] = "Value";
    ObservableValueType[ObservableValueType["Object"] = 2] = "Object";
    ObservableValueType[ObservableValueType["Array"] = 3] = "Array";
...
var ObservableValue = (function () {
            ...
            if (Array.isArray(val)) {
                ...
                for (var x = 0; x < val.length; x++) {
                    ...
                    if (curVal)
                        ...
                        nextArr[x] = new observable_1_1.default(newVal);
                }
                if (val.length < nextArr.length)
                ...
                for (var key in val) {
                    ...
                    if (curVal) {
                        ...
                        nextObject[key] = new observable_1_1.default(newVal);
                    }
                    props.push(key);
                }
    ...
    ObservableValue.prototype.Destroy = function () {
        for (var x = 0; x < this.Properties.length; x++) {
            var prop = this.Properties[x];
    ...
    ObservableValue.prototype.RemovePropertiesFromValue = function (properties) {
        if (!this.value)
            return;
    ...
    ObservableValue.prototype.AddArrayMixin = function (object) {
        ...
        Object.defineProperty(object, "push", {
            value: function (newVal) {
                ...
                var newObs = new observable_1_1.default(newVal);
            ...
            value: function (startIndex, count) {
                ...
                for (var x = 0; x < args.length + tailLength; x++) {
                    ...
                    if (index < _this.value.length)
                        ...
                        _this.value.push(new observable_1_1.default(value));
                }
...
(function (ObservableValue) {
    function Unwrap(value) {
        ...
        for (var x = 0; x < properties.length; x++) {
            returnValue[properties[x]] = observable_1_1.default.Unwrap(value.Value[properties[x]]);
        }
        return returnValue;
    }
