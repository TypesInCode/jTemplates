...
class Observable extends emitter_1.default {
    ...
    DefineProperty(prop, value, join) {
    ...
    AddArrayMixin() {
        ...
        Object.defineProperty(this.ObservableValue, "push", {
            value: (newValue) => {
                if (this._joinedObservable) {
                    this._joinedObservable.ObservableValue.push(newValue);
                }
                else {
    ...
    RemoveArrayMixin() {
        ...
        delete this.ObservableValue["slice"];
    }
}
...
(function (Observable) {
    function Unwrap(value) {
        ...
        var returnValue = obs.Type === ValueType.Array ? [] : {};
