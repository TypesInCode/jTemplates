...
function GetCurrentValues(oldValues, newValues) {
    var currentValues = [];
    for (var x = 0; x < newValues.length; x++) {
        var v = newValues[x];
        if (oldValues.indexOf(v) >= 0)
...
function AddArrayMixin(object) {
    var _this = this;
    Object.defineProperty(object, "length", {
        get: function () { return object.GetValue().length; },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(object, "push", {
        value: function (newValue) {
            ...
            DefineProperty(_this, value.length, newValue);
        },
        enumerable: false,
        configurable: true
    });
}
function RemoveArrayMixin(object) {
...
function DefineProperty(object, property, value) {
    ...
    Object.defineProperty(object, property, {
        get: function () { return object.GetValue()[property]; },
        set: function (val) { return object.GetValue()[property].SetValue(val); },
        enumerable: true,
        configurable: true
    });
}
